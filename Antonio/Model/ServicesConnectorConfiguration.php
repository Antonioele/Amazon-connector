...
class ServicesConnectorConfiguration
{
     ...
     */
    const MODULE_NAME = 'Aiello1_Antonio';
    ...
    {
        $shouldUseServicesConnectorSandboxApiKey
            = $this->getUseServicesConnectorSandboxApiKeyConfig();
     ...
     * Note: This function can be deleted once ServicsConnector extension exposes the URL using an interface
     * @return string
     */
